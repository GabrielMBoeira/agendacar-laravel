    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Nós somos a solução para seus agendamentos... <br> faça um teste!</h1>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p>É uma ferramenta especializada em lavação de carros onde iremos fidelizar seus clientes, garantindo o conforto para seus clientes e consequentemente fidelizando clienteS.
